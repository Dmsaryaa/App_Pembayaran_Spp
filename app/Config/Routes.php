 ...
 * Jenis Pembayaran
 * --------------------------------------------------------------------*/
$routes->get('/jenispbayar', 'JenisPbayarController::index', ['filter' => 'auth']);

$routes->add('jenispbayar', 'JenisPbayarController::save');

$routes->get('/jenispb/delete/(:segment)', 'JenisPbayarController::delete/$1');
$routes->add('/jenispb/edit/(:segment)', 'JenisPbayarController::edit/$1');
...
$routes->add('siswa', 'SiswaController::save');

$routes->get('/siswa/delete/(:segment)', 'SiswaController::delete/$1');
$routes->add('/siswa/edit/(:segment)', 'SiswaController::edit/$1');
...
$routes->add('/bill/(:segment)', 'TransaksiController::bill/$1');
